...
<div class="form-group">
    {!! Form::label('lblselect', 'Seleccione Almacen', ['class' => 'col-sm-2 col-sm-2 control-label']) !!}
    <div class="col-sm-10">
        {!! Form::select('WareHouse_id', $warehouse, $freezer->warehouse_id, ['class' => 'form-control', 'placeholder' => 'Ingrese Almacen']) !!}
    </div>
</div>