            ...
            <div   class="row">
                <div  class="col-md-6">
                    <div  id="content" class="content-panel  content">
                        <h4><i class="fa fa-angle-right"></i> Congeladores</h4>
                        <hr/>
                        ...
                        {!! Form::open(['route' => 'freezer.create', 'method' => 'POST', 'class' => 'form-horizontal style-form']) !!}
                            @include('freezer.partials.fields')
