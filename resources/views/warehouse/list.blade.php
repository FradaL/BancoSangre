            ...
            <div class="row mt">
                <div class="col-lg-12 col-xs-12">
                    <div class="content-panel">
                        <h4><i class="fa fa-angle-right"></i>Listado de Almacenes</h4>
                        ...
                        <section id="no-more-tables">
                            <div>
                                <br/>
                                <p>
                                    &nbsp;&nbsp; <a href="{{ route('warehouse.new') }}" type="button" class="btn btn-theme02"><i class="fa fa-plus"></i> Nuevo Almacen </a>
                                </p>
                            </div>
                            <br/>
                            <br/>
                                ...
                                @foreach($warehouse as $dato)
                                    <tr>
                                        ...
                                        <td data-title="Opciones">
                                            @if($dato->status_delete == 'Activo')
                                                <a href="{{ route('warehouse.edit', $dato->id)  }}" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i> </a>
                                                {!!Form::open(['route' => ['warehouse.delete', $dato], 'method' => 'DELETE', 'class' => 'clase'])  !!}
                                                ...
                                                {!! Form::close() !!}
                                            @else
                                                {!!Form::open(['route' => ['warehouse.activate', $dato], 'method' => 'DELETE', 'class' => 'clase'])  !!}
